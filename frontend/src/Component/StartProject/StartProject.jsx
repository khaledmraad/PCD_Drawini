...
export default function StartProject(){
    ...
    const hint = <h1>My custom hint</h1>;
    const note = <h1>My custom note</h1>;
        ...
        <>
            ...
            <div className="p-4 sm:ml-64">
                ...
                <div class="max-w-2xl mx-auto">
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="dropzone-file" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-bray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            ...
                            <input onChange={()=>console.log("jdchqjsdjkhcb")} id="dropzone-file" type="file" class="hidden" />
                        </label>
                    </div>
                </div>
                </div>
                ...
                <div className="flex p-4 rounded-lg dark:border-gray-700 mt-14">
                    ...
                    <CanvasSizeCard class="m-5" content="1920 x 1080"></CanvasSizeCard>
                    <CanvasSizeCard class="m-5" content="1920 x 1080"></CanvasSizeCard>
                    <CanvasSizeCard class="m-5" content="1920 x 1080"></CanvasSizeCard>
